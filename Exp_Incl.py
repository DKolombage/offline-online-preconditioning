...
# data/Incl/cnt_10 -->  alpha =0.1, beta=1.0, Nsamples = 150
# data/Incl/cnt_100 -->  alpha =0.1, beta=10, Nsamples = 150
# data/Incl/cnt_500 -->  alpha =0.1, beta=50, Nsamples = 150
OUT_DIR = "data/Test/" 
...
# ==============================================================
# Compute avg iterations AFTER removing non-converged
# ==============================================================
def average_iters(Z):
